...
it('verifies if there are no project and displays an error message',
    function () {
        // Act
...
it('verifies if the informations of every project are correct in the project views',
    function () {
...
it('displays a complete list of projects on the project index page',
    function () {
        // Arrange
