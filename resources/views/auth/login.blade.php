...
<body class="bg-gray-100 flex justify-center items-center min-h-screen">
    <section class="p-8 max-w-lg bg-white rounded-2xl">
        ...
        <p class="pb-2 text-sm">Les champs renseignés avec <span class="text-blue-600">*</span> sont obligatoires</p>
        <form class="flex flex-col" action="{!! route('login.store') !!}" method="post" novalidate>
            ...
            <fieldset class="flex flex-col">
                ...
                <div class="flex flex-col pb-6 relative">
                    <label class="pb-1" for="email">Adresse e-mail<small class="text-blue-600"> *</small></label>
        ...
        <p class="mt-4 text-center">Pas encore de compte ?
            <a href="#" class="text-blue-600 pl-1">Créer un compte</a>
        </p>
    </section>
</body>
</html>
